...
const Contact = () => {
  ...
  const whatsappMessage = encodeURIComponent("Hello B360! I'm interested in your services and would like to learn more.");
  ...
  return (
    <div className='relative'>
      ...
      <motion.div
        ref={heroRef}
        className='text-white bg-cover bg-center bg-no-repeat min-h-[300px] sm:min-h-[350px] md:min-h-[300px] w-full flex flex-col justify-center px-4 sm:px-6 lg:px-8 overflow-visible'
        style={{
          backgroundImage: `linear-gradient(to right, rgba(0, 6, 71, 0.85), rgba(0, 6, 71, 0.7)), url(${hero})`,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-bold-blue mb-6">Send Us a Message</h2>
              <form>
                <div className="mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-bold-blue mb-6">Reach Us Directly</h2>
              ...
              >
                <div className="flex items-center">
                  <div className="bg-blue-500 p-3 rounded-full mr-4">
                    <Icon icon="material-symbols:mail" className="h-6 w-6 text-white" />
                  </div>
                  <div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800 mt-2">
                      426a titilayo adedoyin street, omole phase 1 <br />
                      Lagos, Nigeria
                    </p>
                  </div>
                </div>
